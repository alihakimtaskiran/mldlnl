...
<ul>
 ...
 <br>
     ...
     <br>
     <li>
     <ul><pre><b>Perceptron(neurons,activation_fun="tanh")</b> Perceptron object utilizes creating multi layer perceptrons with specified activation function </pre></ul>
